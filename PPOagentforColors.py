...
log_dir = "runs/ColorsEnvPAM_delta=0_"+str(start_time)
# writer = SummaryWriter(log_dir=log_dir,comment='SPMs Reward Record')
print("============================================================================================")
####### initialize environment hyperparameters ######
env_name = "ColorsEnv-v0"  # 定义自己的环境名称
...
################### checkpointing ###################
run_num_pretrained = 'Colors30-20with_PAM_delta=0#0'  #### change this to prevent overwriting weights in same env_name folder
